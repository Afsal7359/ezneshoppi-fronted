...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-5 z-50 w-14 h-14 rounded-full shadow-2xl hover:scale-110 active:scale-95 transition-transform grid place-items-center"
    ...
    >
      ...
      />
      {/* WhatsApp icon */}
      <svg viewBox="0 0 24 24" width="30" height="30" fill="white" className="relative z-10">
